...
public class MakeOfferPage extends BasePage {
    ...
    private final Button currencyMenu = new Button(By.cssSelector("//div[@class='input-wrapper']//div[@class='dropdown__toggle']"));
    private final Button dateMenu = new Button(By.cssSelector("//div[.//h3[text()=' Offer expiration ']]//div[@class='dropdown__toggle']/button[contains(@class,'wide-button text-left')]"));
    private String itemDate = "//p[text()='%s']";
    private final Button fourKb = new Button(By.cssSelector("//p[text()='4KB']"));
    private final Button makeOfferBtn = new Button(By.cssSelector("//div[@class='modal-footer offer-modal__footer']//button"));
    private final Button closeMakeOfferModal = new Button(By.cssSelector("//button[contains(@class,'close')]"));
